...
This document contains a list of third-party software used in this project.

---

- [Kotlin](https://kotlinlang.org/) - The Kotlin programming language, licensed under the [Apache License 2.0](https://www.apache.org/licenses/LICENSE-2.0).
...
- [Kotest](https://kotest.io/) - A testing framework for Kotlin, licensed under the [Apache License 2.0](https://www.apache.org/licenses/LICENSE-2.0).
- [KSP](https://github.com/google/ksp) - A Kotlin Symbol Processing API, licensed under the [Apache License 2.0](https://www.apache.org/licenses/LICENSE-2.0).
